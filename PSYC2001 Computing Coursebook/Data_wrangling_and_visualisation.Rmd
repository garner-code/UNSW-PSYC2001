...
**To-do:  
- add summary of what we'll do this week.  
- add description of .proj file to click on, and the script to open.  
- create the script for the week (half started).  
- amend text below to refer to the code in the script.**
...
In your open script, highlight and run this block of code.
...
**To-do:  
- change this image for running the code in the script**
