...
This dataset is called 'PSYC2001_global-time-on-social-data.csv'. The following is a brief summary of this dataset:
...
1) The online bookdown with access to Chapter 3 which contains the full set of instructions. 

2) "What_is_the_sampling_distribution_of_the_mean.Rproj" which contains the R project file.

3) "What_is_the_sampling_distribution_of_the_mean.Rmd" which contains the Rmarkdown file.


Note: 
We introduce an extension exercise for this week for students that finish early. Please be clear, that this exercise is optional but available for students that wish to extend their understanding of the importance of the sampling distribution of the mean.